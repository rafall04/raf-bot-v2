        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="dashboard-header">
            ...
            <p>Kelola dan monitor migrasi database</p>
                    ...
                    <p class="mb-4">Gunakan halaman ini untuk memigrasikan data pelanggan dari <code>users.json</code> ke database SQLite.</p>
                    <!-- Table Section -->
          <h4 class="dashboard-section-title">Proses Migrasi</h4>
          <div class="card table-card mb-4">
            <div class="card-header">
              <h6>Proses Migrasi</h6>
                        </div>
                        <div class="card-body">
                            <p>Klik tombol di bawah untuk memulai proses migrasi. Proses ini tidak dapat diurungkan. Pastikan Anda telah membuat cadangan data jika diperlukan.</p>
                            <button id="start-migration-btn" class="btn btn-primary">Mulai Migrasi</button>
            ...
            $('#start-migration-btn').on('click', function() {
                ...
                .then(data => {
                    if (data.status === 200) {
                        ...
                        btn.prop('disabled', false).html('Mulai Migrasi');
                    }
                })
                .catch(err => {
